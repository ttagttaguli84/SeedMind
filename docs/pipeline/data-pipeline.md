...
**총 예상 에셋 수**: ~247개 SO 에셋 (ARC-033 +33, ARC-045 GatheringCatalogData 27, ARC-043 DecorationItemData 29+DecorationConfig 1 추가, 갱신)
...
| buyPrice | int | 0 | 구매 가격 (-> see `docs/systems/decoration-system.md` 섹션 2.1~2.5) |
...
| unlockLevel | int | 0 | 해금 필요 레벨; 0 = 시작부터 가능 (-> see `docs/systems/decoration-system.md` 섹션 4.2) |
...
| lightRadius | float | 0 | 조명 반경 — Light 전용 (-> see `docs/systems/decoration-system.md` 섹션 2.3) |
| moveSpeedBonus | float | 0 | 이동속도 보너스 비율 — Path 전용 (-> see `docs/systems/decoration-system.md` 섹션 2.2) |
| durabilityMax | int | 0 | 내구도 최대값 — Fence 전용; 0 = 영구 (-> see `docs/systems/decoration-system.md` 섹션 2.1) |
...
buyPrice, unlockLevel, lightRadius, moveSpeedBonus, durabilityMax 등 **콘텐츠 수치는 `docs/systems/decoration-system.md` 섹션 2.1~2.5에서만 정의**한다. 이 테이블에 직접 기재하지 않는다 (PATTERN-007).
...
| fenceDurabilityDecayPerSeason | float | 0 | 울타리 계절당 내구도 감소율 (-> see `docs/systems/decoration-system.md` 섹션 2.1) |
| fenceRepairCostRatio | float | 0 | 수리 비용 = buyPrice × repairRatio (-> see `docs/systems/decoration-system.md` 섹션 2.1) |
| pathSpeedBonusEnabled | bool | true | Path 이동속도 보너스 활성화 여부 (-> see `docs/systems/decoration-system.md` 섹션 2.2) |

fenceDurabilityDecayPerSeason, fenceRepairCostRatio 등 **콘텐츠 수치는 `docs/systems/decoration-system.md`에서만 정의**한다 (PATTERN-007).
