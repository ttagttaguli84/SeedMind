...
| D | Feature Systems (기능 시스템) | 도구 업그레이드, 가공, 퀘스트, 업적 |
| E | UI & UX | UI 시스템 통합, 튜토리얼, 사운드 |
...
| crop-content-tasks.md | 미기재 |
| time-season-tasks.md | ~312회 (단축 시 ~126회) |
| progression-tasks.md | 미기재 |
...
| B | progression-tasks.md | BAL-002-MCP | scene-setup-tasks.md | 미기재 |
| C | crop-content-tasks.md | CON-001-ARC | scene-setup-tasks.md, farming-tasks.md | 미기재 |
...
| E | tutorial-tasks.md | ARC-010 | scene-setup-tasks.md, farming-tasks.md, tool-upgrade-tasks.md, npc-shop-tasks.md | ~352회 |
...
콘텐츠 위에 올라가는 기능 시스템. 도구 업그레이드, 대장간, 가공, NPC, 퀘스트, 업적을 포함한다.
...
예상 MCP 호출: ~175 + ~255 + 미기재 + ~94 = **~524회 + crop-content 미기재**
