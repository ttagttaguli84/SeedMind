# 도구 업그레이드 시스템 MCP 태스크 시퀀스 (ARC-008)
...
set_property  target: "SO_Tool_Sickle_Legendary"
  ...
  upgradeGoldCost = 0                         // 최종 등급이므로 0
  upgradeTimeDays = 0                         // 최종 등급이므로 0
  specialEffect = "DoubleHarvest"            // 보너스 수확 + 품질 상승 + 씨앗 회수 (-> see docs/systems/tool-upgrade.md 섹션 3.3)
...
| `docs/systems/npc-shop-architecture.md` | NPCController, DialogueSystem, ToolUpgradeSystem 연동 흐름 |
