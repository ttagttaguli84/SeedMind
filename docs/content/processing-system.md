...
|--------|---------|------|----------|------|----------|
| 가공소 (일반) | `building_processing` | (-> see `docs/design.md` 섹션 4.6) | (-> see `docs/design.md` 섹션 4.6) | 잼, 주스, 절임 | 18종 |
| 제분소 | `building_mill` | 레벨 5 | 1,500G | 곡물/작물 -> 가루/분말 | 4종 |
| 발효실 | `building_fermentation` | 레벨 8 | 4,000G | 과일/채소 -> 와인, 식초, 된장 등 | 5종 |
| 베이커리 | `building_bakery` | 레벨 9 | 5,000G | 가공품 + 가공품 -> 고급 요리 | 5종 |

**총 레시피 수: 32종** (일반 가공소 18종 + 제분소 4종 + 발효실 5종 + 베이커리 5종)
