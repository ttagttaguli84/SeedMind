...
겨울무 ROI 예상:
  씨앗비용: 20G, 판매가: 45G
  순이익: 25G, ROI: 125%, 일일 수익률: 6.25G/일
  28일 시즌 7회전: 순이익 175G/타일
```
...
| **재배 계절** | 온실 전용 (겨울 시즌에 온실에서만 재배 가능) |
| **성장 기간** | 6일 (첫 수확), 재수확 간격 4일 `[NEW]` |
| **씨앗 구매가** | 50G `[NEW]` |
| **판매가** | 70G `[NEW]` |
| **해금 조건** | 레벨 6 `[NEW]` |
| **특수 메카닉** | **다중 수확** -- 첫 수확 후 4일 간격으로 재수확 가능. 겨울 시즌 종료 시 고사. (상세: 섹션 4.1) |
| **점보 성장** | 불가 |
...
표고버섯 ROI 예상 (겨울 28일):
  씨앗비용: 50G
  첫 수확 Day 6: 70G
  재수확 Day 10, 14, 18, 22, 26: 5회 x 70G = 350G
  총 수확: 6회 x 70G = 420G
  순이익: 370G, 일일 수익률: 370G / 28 = 13.2G/일
```
...
## 6. 신규 작물 design.md 반영 필요 사항 `[NEW]`

아래 3종은 `docs/design.md` 섹션 4.2 작물 테이블에 추가해야 한다.

| 작물 | 성장 기간 | 판매가 | 씨앗가 | 해금 조건 | 재배 계절 |
|------|-----------|--------|--------|-----------|----------|
| 겨울무 | 4일 | 45G | 20G | 레벨 5 | 온실 전용 |
| 표고버섯 | 6일 (재수확 4일) | 70G | 50G | 레벨 6 | 온실 전용 |
