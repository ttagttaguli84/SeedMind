...
| `maxStack` | 30 |
| 카테고리 | `Gathered` |
| **가공 연계** | **송이 구이** (송이버섯 x1 -> 송이 구이 x1, 베이커리, 30분, 55G). Rare 버섯의 간편 고급 요리. (-> see `docs/content/processing-system.md` 섹션 3.7.3, `recipe_gather13`) |
...
| 12 | 봄나물 비빔밥 | `recipe_gather12` | 베이커리 | 30G | 1.67x | 섹션 3.7.3 |
| 13 | 송이 구이 | `recipe_gather13` | 베이커리 | 55G | 1.72x | 섹션 3.7.3 |
...
| 달래x2+봄나물x1 | 18G | 30G | 1.67x | 적정 (복합 재료 + 연료 30G) |
| 송이버섯 x1 | 32G | 55G | 1.72x | 적정 (Rare + 연료 30G) |
