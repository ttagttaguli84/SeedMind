...
| 이벤트 | 알림 방식 | 위치 | 지속 시간 |
|--------|----------|------|-----------|
| 단일 업적 달성 | 토스트 알림 | 화면 좌측 하단 | 4초 |
| 단계형 업적 단계 달성 | 토스트 알림 + 단계 아이콘 | 화면 좌측 하단 | 4초 |
| 숨겨진 업적 달성 | 특별 토스트 (반짝임 효과) + "숨겨진 업적 달성!" 텍스트 | 화면 좌측 하단 | 6초 |
| 칭호 해금 | 토스트 알림 하단에 "새 칭호: [칭호명]" 추가 | 화면 좌측 하단 | 4초 |
