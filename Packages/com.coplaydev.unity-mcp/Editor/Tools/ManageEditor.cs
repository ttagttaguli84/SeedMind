    ...
    public static class ManageEditor
    {
        ...
        public static object HandleCommand(JObject @params)
        {
            ...
            switch (action)
            {
                ...
                case "get_state":
                    return new SuccessResponse("Editor state retrieved.", new
                    {
                        ...
                        activeScene      = UnityEditor.SceneManagement.EditorSceneManager
                                              .GetActiveScene().name,
                        activeScenePath  = UnityEditor.SceneManagement.EditorSceneManager
                                              .GetActiveScene().path,
                        activeSceneDirty = UnityEditor.SceneManagement.EditorSceneManager
                                              .GetActiveScene().isDirty,
                    });

                default:
                    return new ErrorResponse(
                        $"Unknown action: '{action}'. Supported actions: play, pause, stop, get_state, set_active_tool, add_tag, remove_tag, add_layer, remove_layer, deploy_package, restore_package, undo, redo."
                    );
            }
        }
